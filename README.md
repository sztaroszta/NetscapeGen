...
*   **Header Configuration:** A dialog will ask if your headers are in Row 1 (Standard) or Row 2.
   <p align="center"> <img src="assets/header_config.png" alt="Header Configuration" height="450"/> </p>
...
*   **Review Summary:** Once complete, a summary report will detail the number of bookmarks and folders created.
    <p align="center"> <img src="assets/completion_report.png" alt="Completion Report" width="600"/> </p>
...
*   Check your browser (usually in the "Imported" folder or on the Bar) to verify the folder structure and links.
    <p align="center"> <img src="assets/chrome_results.png" alt="Chrome Import Results" width="450"/> </p>
...
<p align="left"><img src="assets/excel_to_netscape_banner_2.png" alt="NetscapeGen Banner 2" width="600"/> </p>
